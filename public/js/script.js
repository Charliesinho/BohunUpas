...
window.addEventListener("load", () => {
  ...
  if (sessionInProgress) {
    ...
    function roomTransitioning(deltaTime) {
      if (roomTransit) {
        if (levelScreen === -10) {
          ...
          if (transitDir === "down" && game.backgrounds[levelScreen].y < 0) {
            transitMoveElements(deltaTime);
          // Moving UP a screen
          } else if (transitDir === "up" && game.backgrounds[levelScreen].y > 0) {
            transitMoveElements(deltaTime);
    ...
    function checkLevelEvents() {  
      ...
      if (level4Spawn && levelScreen === 4 && !roomTransit) {
        ctx.drawImage(spawnImg, myCanvas.width / 2 - 72, myCanvas.height / 2  - 72, 72, 72)
      }
      if (level8Spawn && levelScreen === 8 && !roomTransit) {
        ctx.drawImage(spawnImg, myCanvas.width / 2 - 72, myCanvas.height / 2  - 72, 72, 72)
      }
    ...
    function loadWorld() {
      // Get Backgrounds
      game.backgrounds.push(new Background(0, 0, myCanvas.width, myCanvas.height, `../images/Meadow/Backgrounds/meadow5.png`));
      game.backgrounds.push(new Background(myCanvas.width, 0, myCanvas.width, myCanvas.height, `../images/Meadow/Backgrounds/meadow0.png`));
      game.backgrounds.push(new Background(myCanvas.width, -myCanvas.height, myCanvas.width, myCanvas.height, `../images/Meadow/Backgrounds/meadow1.png`));
      ...
      game.backgrounds.push(new Background(myCanvas.width * 2, 0, myCanvas.width, myCanvas.height, `../images/Meadow/Backgrounds/meadow3.png`));
      game.backgrounds.push(new Background(myCanvas.width * 2, -myCanvas.height, myCanvas.width, myCanvas.height, `../images/Meadow/Backgrounds/meadow4.png`));
